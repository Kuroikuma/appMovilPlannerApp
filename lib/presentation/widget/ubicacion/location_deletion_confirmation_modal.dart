...
class _LocationDeletionConfirmationModalState
  ...
  void _validateVerificationCode(String value) {
    setState(() {
      ...
      _errorMessage =
          _isVerificationCodeValid ? null : 'Código de verificación requerido';
    });
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoSection(
                          ...
                          content:
                              'Al eliminar esta ubicación, se desvinculará completamente de este dispositivo. No podrás registrar asistencia ni acceder a la información asociada a esta ubicación.',
                        ...
                        _buildInfoSection(
                          ...
                          content:
                              'Después de eliminar esta ubicación, podrás verificar una nueva ubicación utilizando otro código QR o código de verificación. Esto te permitirá configurar el dispositivo para una ubicación diferente.',
  ...
  Widget _buildVerificationCodeField(ColorScheme colorScheme) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(Icons.vpn_key_outlined, color: colorScheme.primary),
